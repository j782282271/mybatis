...
public class Reflector {
    ...
    private void addGetMethods(Class<?> cls) {
        //子类可能覆盖父类方法，同一方法签名下面可能有多个Method,可能是子类的也可能是父类的
        Map<String/**属性名*/, List<Method>> conflictingGetters = new HashMap<String, List<Method>>();
    ...
    private void addUniqueMethods(Map<String, Method> uniqueMethods, Method[] methods) {
        for (Method currentMethod : methods) {
            //桥接方法见：https://www.cnblogs.com/zsg88/p/7588929.html
